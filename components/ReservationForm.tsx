...
const locations = [
  { code: 'FEZ', name: 'Aéroport de Fès-Saïs - Avenue Mecque, Fès 30070' },
  { code: 'CFE', name: 'Fès-centre ville - Avenue Mecque, Fès 30070' },
...
export default function ReservationForm({ car, onClose }: ReservationFormProps) {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    const message = 
      ...
      `*Réservation envoyée via Location Maroc*\n` +
      `*Service client:* +212648985150`;

    const encodedMessage = encodeURIComponent(message);
    const whatsappUrl = `https://wa.me/212648985150?text=${encodedMessage}`;
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                {...register('email')}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary text-sm"
                placeholder="amsicarfes@gmail.com"
              />
              {errors.email && (
